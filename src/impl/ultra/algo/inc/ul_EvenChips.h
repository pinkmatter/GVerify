...
class CEvenChips : public CChipsGen<float>
{
public:

    class CEvenChipsContext : public CChipsGen<float>::CChipsGenContext
    {
    public:
        int chipSize;
        ...
        virtual ~CEvenChipsContext()
        {
        }
    };
private:
    CEvenChipsContext *m_context;
    SSize m_imgSize;
